...
impl Container {
    pub fn new () -> Self {
        // Notes: environment is mandatory parameter according to the manual
        // however
        //  - it can be ignored
        //  - sending an empty value {} or null will lead to error
        Container {
            environment: vec![("CHIRAL_SILVA_VERSION", "v0.2.4")].into_iter()
...
impl Container {
    ...
    pub fn environment(mut self, environment: HashMap<String, String>) -> Self { self.environment = environment; self }
